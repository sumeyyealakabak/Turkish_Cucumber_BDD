...
public class QdStepdefinitions {
    ...
    public void username_olarak_girer(String username) {
        qdPage.emailKutusu.sendKeys(ConfigReader.getProperty(username)); //***** sadece "username olarak {string} girer" deyince ***
    }
    @Then("password olarak {string} girer")
    public void password_olarak_girer(String password) {
        qdPage.passwordKutusu.sendKeys(ConfigReader.getProperty(password)); //***** sadece "password olarak {string} girer" deyince ***
    }
    ...
    public void usernameOlarakExamplesDanGirer(String username) {//burda username olarak EXAMPLES dan {string} girer" diyince
        qdPage.emailKutusu.sendKeys(username);
    }

    @And("password olarak examples dan {string} girer")
    public void passwordOlarakExamplesDanGirer(String password) {//burda password olarak EXAMPLES dan {string} girer" diyince
